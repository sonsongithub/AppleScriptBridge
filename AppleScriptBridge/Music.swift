...
@objc public protocol MusicApplication {
    ...
    @objc optional func setCurrentPlaylist(_ currentPlaylist: MusicPlaylist)
    @objc optional var currentStreamTitle: NSString { get }
    @objc optional func setCurrentStreamTitle(_ currentStreamTitle: NSString)
    @objc optional var currentStreamURL: NSString { get }
    @objc optional func setCurrentStreamURL(_ currentStreamURL: NSString)
    @objc optional var currentTrack: MusicTrack { get }
    @objc optional func setCurrentTrack(_ currentTrack: MusicTrack)
    ...
    @objc optional func setSelection(_ selection: SBObject)
    ...
    @objc optional func setVersion(_ version: NSString)
...
@objc public protocol MusicItem : MusicGenericMethods {
    ...
    @objc optional func setContainer(_ container: SBObject)
    @objc optional var index: NSInteger { get }
    @objc optional var name: NSString { get }
    @objc optional func setName(_ name: NSString)
    @objc optional var persistentID: NSString { get }
    @objc optional func setPersistentID(_ persistentID: NSString)
...
@objc public protocol MusicAirPlayDevice : MusicItem {
    ...
    @objc optional func setNetworkAddress(_ networkAddress: NSString)
...
@objc public protocol MusicArtwork : MusicItem {
    ...
    @objc optional func setFormat(_ format: NSNumber)
...
@objc public protocol MusicEncoder : MusicItem {
    ...
    @objc optional func setFormat(_ format: NSString)
}
...
@objc public protocol MusicTrack : MusicItem {
    ...
    @objc optional func setDateAdded(_ dateAdded: NSDate)
    @objc optional var objectDescription: NSString { get }
    @objc optional func setObjectDescription(_ objectDescription: NSString)
    @objc optional var discCount: NSInteger { get }
    @objc optional func setDiscCount(_ discCount: NSInteger)
    ...
    @objc optional func setDownloaderAccount(_ downloaderAccount: NSString)
    @objc optional var downloaderName: NSString { get }
    @objc optional func setDownloaderName(_ downloaderName: NSString)
    ...
    @objc optional func setKind(_ kind: NSString)
    ...
    @objc optional func setModificationDate(_ modificationDate: NSDate)
    ...
    @objc optional func setPurchaserAccount(_ purchaserAccount: NSString)
    @objc optional var purchaserName: NSString { get }
    @objc optional func setPurchaserName(_ purchaserName: NSString)
    ...
    @objc optional func setReleaseDate(_ releaseDate: NSDate)
